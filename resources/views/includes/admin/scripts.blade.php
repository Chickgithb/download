...
<!--timeline_horizontal-->
<script src="{{ asset('assets/js/vendor/jquery.mobile.custom.min.js') }}"></script>
<script src="{{ asset('assets/js/vendor/hTimeline.js') }}"></script>
<!-- amcharts -->
<script src="{{ asset('assets/js/vendor/amcharts/amcharts.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/serial.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/pie.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/gantt.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/funnel.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/radar.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/amstock.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/ammap.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/worldLow.js') }}"></script>
<script src="{{ asset('assets/js/vendor/amcharts/light.js') }}"></script>
<!-- Peity -->
<script src="{{ asset('assets/js/vendor/peityJs/jquery.peity.min.js') }}"></script>
<!-- fullcalendar -->
...
<!-- adminbag demo js-->
<script src="{{ asset('assets/js/adminbagdemo.js') }}"></script>
@yield('scripts')
<!-- start theme config -->
 ...
 <div class="setings-item gohome "> <span class="skin-name"> <a href="http://adminbag-v1.3.bittyfox.com/"> Go to Lending Page </a> </span> </div>
      </div>
    </div>
  </div>
  <!-- end theme config -->
...
<div class="request-form ng-scope">
  ...
  <div class="container">
    ...
    <div class="hover14 column row">
      <div class="col-lg-4"> <a href="http://adminbag-v1.3.bittyfox.com/default/aqua-black/index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/aqua-black.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
        <span>Aqua Black</span> </a> </div>
      <div class="col-lg-4"> <a href="http://adminbag-v1.3.bittyfox.com/default/dark/index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/dark.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
        <span>Dark</span> </a> </div>
      <div class="col-lg-4"> <a href="http://adminbag-v1.3.bittyfox.com/default/dark-blue/index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/dark-blue.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
        <span>Dark Blue</span> </a> </div>
    </div>
    <div class="hover14 column row">
      <div class="col-lg-4"> <a href="http://adminbag-v1.3.bittyfox.com/default/light/index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/light.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
        <span>Light</span> </a> </div>
      <div class="col-lg-4"> <a href="http://adminbag-v1.3.bittyfox.com/default/red-black/index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/red-black.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
        <span>Red Black</span> </a> </div>
      <div class="col-lg-4"> <a href="index.html">
        <figure><img alt="" class="img-responsive" src="{{ asset('assets/lendingPage/img/themes/white-blue.jpg') }}"><samp class="viewDemo">View Demo</samp> </figure>
