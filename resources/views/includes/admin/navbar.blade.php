<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
      ...
      <div class="top-menu">
        <ul class="nav navbar-nav pull-right">
          ...
          <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle count-info" > <i class="fa fa-bell"></i> <span class="badge badge-info">8</span> </a>
  ...
  <li class="dropdown dropdown-user"> <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown"  class="dropdown-toggle" href="javascript:;"> <img src="{{ asset('assets/images/teem/a10.jpg') }}" class="img-circle" alt=""> <span class="username username-hide-on-mobile"> {{ auth()->user()->name; }}</span> <i class="fa fa-angle-down"></i> </a>
  ...
  <a href="profile_2.html"> <i class="icon-user"></i> Profile-2 </a> </li>
              ...
              <li> <a href="{{ route('admin.logout') }}"> <i class="icon-key"></i> Déconnecter  </a> </li>
            </ul>
          </li>
