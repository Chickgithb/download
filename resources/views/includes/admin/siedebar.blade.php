<div class="page-sidebar-wrapper">
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="nav-item active"> <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-th-large"></i> <span class="title">Dashboard</span> <span class="arrow"></span> </a>
          <ul class="sub-menu">
            <li class="nav-item active"> <a class="nav-link" href="index.html"> <span class="title">Dashboard 1</span> </a> </li>
            ...
            <li class="nav-item"> <a class="nav-link" href="dashboard4.html"> <span class="title">Dashboard 4</span> </a> </li>
          </ul>
        </li>
        <li class="nav-item"> <a class="nav-link" href="{{ route('admin.dashboard') }}"> <i class="fa fa-flash"></i> <span class="title">Principal</span> </a></li>
            <li class="heading">
            <h3 class="uppercase">Features</h3>
        </li>
        <li class="nav-item"> <a class="nav-link nav-toggle" href="javascript:;"> <i class="fa fa-diamond"></i> <span class="title">Service_Gestion</span> <span class="arrow"></span> </a>
          <ul class="sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('Gestion_index') }}" > <span class="title">La Gestion</span> </a> </li>
        ...
        <li > <a class="nav-link nav-toggle" href="javascript:;"><i class="fa fa-envelope"></i> <span class="title">Mailbox </span><span class="label badge-primary pull-right">16/70</span></a>
          <ul class="sub-menu" >
